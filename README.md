...
La rama `feat/vertical-slice` contiene el prototipo en remediacion arquitectonica. No se considera ninguna fase Dajarony cerrada hasta ejecutar `flutter analyze` y `flutter test` en el equipo de desarrollo.
